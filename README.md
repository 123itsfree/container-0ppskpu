...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0ppskpu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0ppskpu.containers.anotherwebservice.com/
...
```
git clone git@github.com:123itsfree/container-0ppskpu.git
cd container-0ppskpu
```
...
```
docker attach container-0ppskpu
```
